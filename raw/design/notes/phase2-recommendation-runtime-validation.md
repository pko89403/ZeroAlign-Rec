...
- [Phase 2 추천 런타임](phase2-recommendation-runtime.md) — 현재 recommendation package와 CLI entrypoint 설명
- [SID 컴파일 및 인덱싱](sid-compilation-indexing.md) — Phase 2가 소비하는 upstream artifact 생성 단계
