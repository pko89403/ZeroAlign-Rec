...
- [SID Phase 1 실행 검증 개요](sid-phase1-validation-run.md) — upstream 산출물 정합성 검증
- [Phase 2 추천 런타임 실행 검증 개요](phase2-recommendation-runtime-validation.md) — 실제 추천 경로에서 확인한 실행 이슈와 안정화 결과
