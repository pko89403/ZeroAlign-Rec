...
- [ADR-003: Neighbor Context 정책 결정](../adr/adr-003-neighbor-context-retrieval.md) — neighbor context 정책 결정
...
- [ADR-006: Strict TID hardening 결정](../adr/adr-006-strict-tid-hardening.md) — top-5 neighbor evidence의 downstream 사용 정책
