...
- [ADR-001: 개발 환경 및 로컬 추론 스택 결정](../adr/adr-001-dev-environment.md) — 생성 모델과 개발 스택 결정
- [ADR-004: Taxonomy Dictionary 생성 방식 결정](../adr/adr-004-taxonomy-dictionary-generation.md) — superseded된 초기 생성 정책
- [ADR-005: Taxonomy Dictionary 생성 hardening 결정](../adr/adr-005-taxonomy-dictionary-hardening.md) — 현재 bounded input/validation 정책
...
- [ADR-006: Strict TID hardening 결정](../adr/adr-006-strict-tid-hardening.md) — downstream canonicalization과 validator 정책
- [Taxonomy Dictionary 개발 이슈 개요](taxonomy-dictionary-development-issues.md) — 구현 및 검증 중 발생한 오류 기록
