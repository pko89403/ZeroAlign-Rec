...
즉, TaxRec의 taxonomy generation 방향은 유지하되,
현재 저장소 환경에 맞는 운영 안정화 계층을 추가하는 결정이다.
...
- [Food Taxonomy Dictionary](../notes/food-taxonomy-dictionary.md) — 현재 생성 규칙과 산출물
...
- [Taxonomy Item Structuring](../notes/taxonomy-item-structuring.md) — hardening된 dictionary를 downstream에 사용하는 단계
- [ADR-006: Strict TID hardening 결정](adr-006-strict-tid-hardening.md) — downstream TID canonicalization과 validator 정책
- [Taxonomy Dictionary 개발 이슈 개요](../notes/taxonomy-dictionary-development-issues.md) — 개발 중 확인된 문제와 해결 내역
