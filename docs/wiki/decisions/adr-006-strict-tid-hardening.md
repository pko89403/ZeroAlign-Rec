...
- [Taxonomy Step 1 이웃 인덱스](../entities/taxonomy-step1-neighbor-index.md) — item evidence를 제공하는 이웃 검색 단계
- [ADR-003: Taxonomy Step 1 이웃 검색 정책 결정](adr-003-taxonomy-step1-neighbor-index.md) — top-5 neighbor context 정책
