---
title: "Neighbor Context 검색 정책 결정"
date: 2026-04-07
type: adr
status: Accepted
sources: []
...
# ADR-003: Neighbor Context 검색 정책 결정
...
Neighbor Context 검색 정책을 아래와 같이 고정한다.
...
- 출력 경로는 `data/processed/foodcom/neighbor_context/`를 기본 경로로 사용한다
- 저장 파일:
...
- [Neighbor Context 인덱스](../entities/neighbor-context-index.md) — 현재 산출물과 사용법
