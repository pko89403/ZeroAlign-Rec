...
Phase 1 마지막 단계에 필요한 중간 산출물과 최종 인덱스 계층을 준비하는 흐름이다.
...
- CLI entry:
  - `uv run sid-reco compile-sid-index --structured-items-path ... --taxonomy-dictionary-path ... --out-dir ...`
...
10. `data/processed/foodcom/sid_index/manifest.json`
