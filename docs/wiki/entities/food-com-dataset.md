...
- [Taxonomy Step 1 이웃 인덱스](taxonomy-step1-neighbor-index.md) — recipe catalog를 사용하는 첫 taxonomy 후보 생성 단계
...
- [ADR-003: Taxonomy Step 1 이웃 검색 정책 결정](../decisions/adr-003-taxonomy-step1-neighbor-index.md) — 이 데이터셋을 입력으로 사용하는 taxonomy step 1 정책
