...
- [Food Taxonomy Dictionary](../entities/food-taxonomy-dictionary.md) — 문제 발생 대상 기능
- [개발 환경 세팅](../entities/dev-environment.md) — 로컬 런타임과 검증 환경
- [ADR-004: Taxonomy Dictionary 생성 방식 결정](../decisions/adr-004-taxonomy-dictionary-generation.md) — superseded된 초기 생성 정책
- [ADR-005: Taxonomy Dictionary 생성 hardening 결정](../decisions/adr-005-taxonomy-dictionary-hardening.md) — 현재 hardening 정책
