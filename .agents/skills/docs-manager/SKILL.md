---
name: docs-manager
description: "Manage the repository documentation and Graphify source corpus end-to-end. Use when: maintain raw/, review Graphify artifacts, update README.md, sync AGENTS.md, sync .github/copilot-instructions.md, sync references/local-adaptation.md, sync .agents/skills/graphify-manager/SKILL.md, or run a full docs/harness sync after code changes."
...
`.github/copilot-instructions.md`, `references/local-adaptation.md`, `.agents/skills/graphify-manager/SKILL.md`)을 함께 관리하는 스킬이다.
...
- [ ] `README.md`, `AGENTS.md`, `.github/copilot-instructions.md`, `references/local-adaptation.md`, `.agents/skills/graphify-manager/SKILL.md`가 `raw/` 모델과 일치하는가?
