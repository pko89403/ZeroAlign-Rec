...
| taxonomy | `src/sid_reco/taxonomy/` | taxonomy step 1 임베딩/FAISS 검색 및 LLM 기반 taxonomy dictionary 생성 |
| cli | `src/sid_reco/cli.py` | `doctor`, `smoke-mlx`, `smoke-llm`, `smoke-embed`, `prepare-foodcom`, `build-taxonomy-step1`, `build-taxonomy-dictionary` |
...
- `/docs-manager` 또는 `/doc-manager` — `docs/sources/`, `docs/wiki/`, `AGENTS.md` 기반 문서 작업
